...
Pod::Spec.new do |s|
  s.name             = 'JZComponents'
  s.version          = '0.1.0'
  s.summary          = 'A short description of JZComponents.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Jentle/JZComponents'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Jentle' => 'juntaozhi@163.com' }
  s.source           = { :git => 'https://github.com/Jentle/JZComponents.git', :tag => s.version.to_s }
